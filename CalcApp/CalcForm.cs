...
namespace CalcApp
{
    ...
    public partial class CalcForm : Form
    {
        ...
        private void ApplyTheme(ThemeMode theme)
        {
            ...
            // Force repaint to ensure background changes properly
            this.Invalidate();
        }
        ...
        private void heartBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                // Stop any existing message timer
                ...
                Color originalColor = textExpression.ForeColor;
                ...
                // Set timer to restore original color after 2 seconds
                messageTimer = new Timer();
                messageTimer.Interval = 2000;
                messageTimer.Tick += (s, args) =>
                {
                    textExpression.ForeColor = originalColor;
                    messageTimer.Stop();
                    messageTimer.Dispose();
                    messageTimer = null;
                };
